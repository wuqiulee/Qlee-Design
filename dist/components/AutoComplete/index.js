...
export var AutoComplete = function (props) {
  var fetchData = props.fetchData,
    ...
    restProps = __rest(props, ['fetchData', 'onSelect', 'value', 'renderOption']);
    ...
    return suggestions.length
      ? React.createElement(
          ...
          loading &&
            React.createElement(
              'div',
              { className: 'suggstions_loading_icon' },
              React.createElement(Icon, { icon: faSpinner, spin: true })
            ),
          suggestions.map(function (item, index) {
            var cnames = classNames('suggestion_item', {
  ...
  useEffect(
    function () {
      if (debouncedValue && triggerSearch.current) {
        setSugestions([]);
        var results = fetchData(debouncedValue);
  ...
  return React.createElement(
    'div',
    { className: 'auto_complete', ref: componentRef },
    React.createElement(
      Input,
